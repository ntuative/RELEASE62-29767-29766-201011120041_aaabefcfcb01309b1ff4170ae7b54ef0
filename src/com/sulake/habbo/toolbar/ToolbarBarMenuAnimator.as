package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1175:Number = 90;
      
      private static const const_851:int = 50;
      
      private static const const_1174:Number = 25;
      
      private static const const_1196:int = 50;
      ...
      private var var_1329:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_582.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_582.splice(_loc3_,1);
            this.var_583.splice(_loc3_,1);
         }
         this.var_583.push(param1.name);
      ...
      {
         return this.var_582[this.var_583.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1329.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_326.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_326.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_326.splice(this.var_326.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = this.var_1329.getIconLoc(param1.iconId);
      ...
      {
         return this.var_583[this.var_582.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_326[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_584[_loc3_] == null)
            {
               this.var_584[_loc3_] = new Array();
            }
            if(this.var_584[_loc3_].indexOf(param1) < 0)
            {
               this.var_584[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_851 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_851 || param1.desktop.height - param1.y < const_1196;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_583[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_582[_loc2_];
               if(this.var_584[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_584[_loc3_].length)
                  {
                     this.repositionWindow(this.var_584[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_326.length)
         {
            _loc2_ = this._itemList[this.var_326[_loc7_]];
            if(_loc2_.active)
            {
