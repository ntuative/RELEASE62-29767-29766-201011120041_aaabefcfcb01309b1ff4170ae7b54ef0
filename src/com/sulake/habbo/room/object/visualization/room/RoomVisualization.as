package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1372:int = 13421772;
      
      private static const const_847:int = 16777215;
      
      public static const const_1453:int = 10066329;
      
      private static const const_848:int = 13421772;
      
      public static const const_1301:int = 16777215;
      
      public static const const_1420:int = 16777215;
      
      private static const const_849:int = 10066329;
      
      private static const const_850:int = 10066329;
      
      public static const const_1281:int = 13421772;
      ...
      private var var_1083:uint = 16777215;
      ...
      private var var_701:Rectangle = null;
      
      private var var_2410:int = 255;
      
      private var var_2408:Boolean = false;
      
      private var var_2409:int = 255;
      
      private var var_2412:String = null;
      
      private const const_1776:int = 250;
      ...
      private var var_474:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_474 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1067);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_255)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1420;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1281;
               }
               else
               {
                  _loc13_.color = const_1453;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1439)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_104,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_209 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1064);
            if(_loc3_ != this.var_2412)
            {
               this.method_9(_loc3_);
               this.var_2412 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_551));
            if(_loc4_ != this.var_1083)
            {
               this.var_1083 = _loc4_;
               this.var_2409 = this.var_1083 & 255;
               this.var_2410 = this.var_1083 >> 8 & 255;
               this.var_2411 = this.var_1083 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1015));
            if(_loc5_ != this.var_1703)
            {
               this.var_1703 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_701 = super.boundingRectangle;
         }
         return new Rectangle(this.var_701.x,this.var_701.y,this.var_701.width,this.var_701.height);
      }
      
      protected function method_9(param1:String) : void
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc12_:* = null;
         ...
         this.var_474.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_474.maskCount)
         {
            _loc10_ = this.var_474.getMaskType(_loc8_);
            _loc11_ = this.var_474.getMaskLocation(_loc8_);
            _loc12_ = this.var_474.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_121.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_104 || _loc3_.type == RoomPlane.const_89)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_104 || _loc3_.type == RoomPlane.const_89 && _loc12_ == RoomPlaneBitmapMaskData.const_195)
                              {
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_183)
                        {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1776 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            while(_loc9_ < this.var_322.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_89)
               {
                  if(this.var_1703)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2409 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2410 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2411 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1432)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1203 || _loc3_.y != this.var_1993 || _loc3_.z != this.var_1996 || param1.scale != this.var_1994))
            {
               this.var_1203 = _loc3_.x;
               this.var_1993 = _loc3_.y;
               this.var_1996 = _loc3_.z;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_209 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_723);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_584);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_653);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_646));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_709));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_557));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1702;
      }
