package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1457:int = const_344;
      ...
      public static const const_271:int = const_103;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1746 == const_103)
         {
            _loc5_ = new Rectangle(0,0,this.var_28.width,this.var_592);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_28.height - this.var_592,this.var_28.width,this.var_592);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_28 != null)
            {
               if(this.var_28.width == param2 && this.var_28.height == param3 && Vector3d.isEqual(this.var_622,param4))
               {
                  if(param1 != null)
                  {
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_622 != null)
         {
            this.var_622.assign(new Vector3d());
         }
         this.var_592 = 0;
         var _loc1_:int = 0;
