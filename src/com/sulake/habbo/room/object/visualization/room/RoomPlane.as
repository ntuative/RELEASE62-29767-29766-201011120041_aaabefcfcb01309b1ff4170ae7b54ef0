package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_390:PlaneBitmapData = null;
      ...
      private var var_686:PlaneMaskManager = null;
      ...
      private var var_718:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2480 = param11;
         this.var_2481 = param12;
         this.var_888 = param6;
      }
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_888)
         {
            ...
            {
               _loc4_ = this.var_239[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_104 || this._type == const_89))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_888 || this.var_239.length == 0 && this.var_329.length == 0 && !this.var_330 || this.var_686 == null)
         {
            return;
         }
         ...
         if(this.var_330)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_520);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_239.length)
            {
               _loc3_ = this.var_239[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc3_.leftSideLoc / this.var_256.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc3_.rightSideLoc / this.var_255.length;
                  _loc12_ = _loc3_.type;
                  this.var_686.updateMask(this.var_65,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_887.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_329.length)
            {
               _loc4_ = this.var_329[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc4_.leftSideLoc / this.var_256.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc4_.rightSideLoc / this.var_255.length;
                  _loc13_ = this.var_65.width * _loc4_.leftSideLength / this.var_256.length;
                  _loc14_ = this.var_65.height * _loc4_.rightSideLength / this.var_255.length;
                  this.var_65.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1354.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_330 = false;
      ...
      {
         return this._isVisible && this.var_718;
      }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_104 || this._type == const_89)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_239.length == this.var_887.length)
         {
            while(_loc1_ < this.var_239.length)
            {
               _loc4_ = this.var_239[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_887.length)
                  {
                     _loc7_ = this.var_887[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_329.length > this.var_1354.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1432 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_718)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1303.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1303[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_968);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_136.z - originZ,this.var_102.z - originZ,this.var_79.z - originZ,this.var_103.z - originZ);
            if(this._type == const_89)
            {
               relativeDepth += 0.02;
            }
            this.var_1992 = relativeDepth;
            this._isVisible = true;
            this.var_1432 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2482);
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_390;
         if(_loc3_ == null)
         {
         ...
         this.updateMaskChangeStatus();
         if(this.var_718 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_330))
         {
            return true;
         }
         return false;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_888)
         {
            ...
            while(_loc6_ < this.var_329.length)
            {
               _loc5_ = this.var_329[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_255.length * param1.scale;
            ...
            if(this.var_886 != null)
            {
               _loc3_ = this.var_886.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1756,this.var_2478,this.var_2479,this.var_2480,this.var_2481,param2);
               if(_loc3_ != null)
               {
