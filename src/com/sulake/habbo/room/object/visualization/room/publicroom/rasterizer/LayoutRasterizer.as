package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1114:Point = null;
      
      private var var_596:Array;
      
      private var var_1363:LayoutRasterizerData = null;
      ...
      private var var_895:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_1178:IGraphicAssetCollection;
      
      private var var_1387:XMLList;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_36.getValue(this.var_896);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1772 = RoomObjectVariableEnum.const_1063;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1772 = RoomObjectVariableEnum.const_987;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1113 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1113 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1113 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1113 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1772);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2505);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1114.x = _loc3_.x;
         this.var_1114.y = _loc3_.y;
      }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_896)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1363 = this.var_36.getValue(this.var_896);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_36.getValue(this.var_896);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1363.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1178.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1114.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1114.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_392.indexOf(_loc10_) >= 0 && this.var_895)
            {
               param1 = this.var_392.indexOf(_loc10_);
               if(this.var_595[param1] != "")
               {
                  _loc9_ = this.var_1178.getAsset(this.var_595[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
