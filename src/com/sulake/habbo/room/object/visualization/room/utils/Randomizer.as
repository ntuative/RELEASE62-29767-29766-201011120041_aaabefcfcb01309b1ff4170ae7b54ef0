package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_2577:int = 69069;
      
      private var var_1545:int = 1;
      
      private var var_2576:int = 5;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1544 * param2);
      }
      ...
      {
         var _loc1_:int = this.var_2577 * this.var_1545 + this.var_2576;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1544;
         this.var_1545 = _loc1_;
         return _loc1_;
      }
