package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1110:String = "shore";
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_414 + 2;
         var _loc4_:int = this.var_512 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1440 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_348.length)
         {
            if(this.var_348[_loc5_] == true)
            {
               this.var_1440 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_513[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_414 == 0 || this.var_512 == 0)
         {
            ...
            this.var_414 = _loc2_.getNumber(RoomObjectVariableEnum.const_301);
            this.var_512 = _loc2_.getNumber(RoomObjectVariableEnum.const_317);
         }
         this.var_348 = [];
         this.var_513 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_414 * 2 + this.var_512 * 2)
         {
            this.var_348.push(false);
            this.var_513.push(ShoreMaskCreatorUtility.const_72);
            _loc1_++;
         }
      }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_513[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc1_:int = this.var_414 + 2;
         var _loc2_:int = this.var_512 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(this.var_1958 == param1 && this.var_1957 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1110)
            {
               this.var_1441 = _loc2_;
               this.var_1958 = param1;
               this.var_1957 = _direction;
               return this.var_1441;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_956.indexOf(_loc2_) < 0)
            {
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_65,getSize(param3),this.var_348,this.var_513,assetCollection);
      }
