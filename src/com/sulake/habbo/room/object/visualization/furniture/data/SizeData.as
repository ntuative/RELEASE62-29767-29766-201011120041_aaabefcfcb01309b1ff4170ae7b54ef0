package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1357:int = 360;
      
      private var var_1547:int = 0;
      
      private var var_1109:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1357 / 2) % 360 / this.var_1357;
         ...
         {
            _loc6_ = int(this.var_240.getKey(_loc5_)) * this.var_1357;
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_933);
                  break;
               case "DARKEN":
