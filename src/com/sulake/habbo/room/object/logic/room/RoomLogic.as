   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_551,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_646,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_709,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_557,1);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1015,int(param1.bgOnly));
         this.var_1312 = this._color;
         this.var_1684 = this.var_1456;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_913:
               param2.setNumber(RoomObjectVariableEnum.const_646,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1034:
               param2.setNumber(RoomObjectVariableEnum.const_709,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_557,_loc3_);
         }
      }
      
      private function method_9(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc7_:* = null;
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_413:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_195)
               {
                  _loc5_ = "null";
               }
               this.var_474.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_588:
               _loc4_ = this.var_474.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_474.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1064,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_697:
               param2.setString(RoomObjectVariableEnum.const_584,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_790:
               param2.setString(RoomObjectVariableEnum.const_723,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_644:
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1067)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1456;
            if(_loc2_ - this.var_1067 >= this.var_1682)
            {
               _loc3_ = this.var_1068;
               _loc4_ = this.var_1683;
               this.var_1067 = 0;
            }
            else
            {
               _loc7_ = this.var_1312 >> 16 & 255;
               _loc8_ = this.var_1312 >> 8 & 255;
               _loc9_ = this.var_1312 & 255;
               ...
               _loc4_ = this.var_1684 + (this.var_1683 - this.var_1684) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_551,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_466,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1438,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1364,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1328,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_466,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_155)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_149 || _loc13_ == RoomPlaneData.const_255)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
