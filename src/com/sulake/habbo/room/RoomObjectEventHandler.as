package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_546);
         }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectFurnitureActionEvent.const_436:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_485));
         }
      }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_34 && _loc3_.typeId == RoomObjectTypeEnum.const_214)
               {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_651,param1,param2,param3,param4));
         }
      }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_28)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_546);
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc10_ != null)
                  {
                     if(_loc12_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_64,MouseEvent.CLICK,_loc10_);
                     }
                     if(_loc13_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_174,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_64)
         {
            _loc14_ = this.getMouseEventId(RoomObjectCategoryEnum.const_64,MouseEvent.CLICK);
            if(_loc14_ != _loc10_)
            {
               _loc15_ = this._roomEngine.events;
               if(_loc15_ != null)
               {
                  _loc15_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_452,param2,param3,-1,RoomObjectCategoryEnum.const_174));
               }
               this.setSelectedAvatar(param2,param3,0,false);
            }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_317);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_258:
               ...
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_410:
               _loc7_ = "null";
               break;
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1289,category) as IRoomObjectController;
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_441:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_516:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_317);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectMoveEvent.const_465:
               ...
               break;
            case RoomObjectMoveEvent.const_464:
            ...
            case RoomObjectRoomAdEvent.const_368:
               ...
               break;
            case RoomObjectRoomActionEvent.const_441:
            case RoomObjectRoomActionEvent.const_955:
            case RoomObjectRoomActionEvent.const_516:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_492:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_482:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_713));
               break;
            case RoomObjectFurnitureActionEvent.const_520:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_485));
         }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:IRoomGeometry) : void
      {
         ...
         if(_loc5_ != RoomObjectCategoryEnum.const_64)
         {
            if(!this._roomEngine.getIsPlayingGame(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory))
            {
               _loc5_ = 0;
