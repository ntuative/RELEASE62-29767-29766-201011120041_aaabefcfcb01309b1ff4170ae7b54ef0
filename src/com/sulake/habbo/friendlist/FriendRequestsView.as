package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1491:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_315 && _loc4_.state != FriendRequest.const_345)
            {
               ...
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_56,_loc4_.requestId));
               }
            }
         }
      ...
      {
         this.var_1415 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1416 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1416.procedure = this.onDismissAllButtonClick;
         this.var_1415.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_315 && _loc4_.state != FriendRequest.const_345)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_273,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1415,_loc1_);
         this.setEnabled(this.var_1416,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_56,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_273,param1));
         }
      }
   }
}
