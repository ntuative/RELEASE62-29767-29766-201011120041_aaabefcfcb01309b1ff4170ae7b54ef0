package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_585:String = "bg";
       
      
      private var var_2379:IContainerButtonWindow;
      
      private var var_2380:IContainerButtonWindow;
      
      private var var_2381:IContainerButtonWindow;
      
      private var var_2378:IContainerButtonWindow;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_342 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2380 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2381 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2379 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2378 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_585);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_342.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2380,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2381,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2379,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2378,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_585);
