package com.sulake.habbo.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1204:Class = ProfilerOutput_habbo_profiler_task_xml;
      
      private static var var_1205:Class = ProfilerOutput_habbo_profiler_dialog_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_23:CoreComponent;
      ...
      public function ProfilerOutput(param1:CoreComponent, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         super();
         this.var_23 = param1;
         this.var_2566 = new Array();
         this.var_137 = this.profiler;
         this._windowManager = param2;
         this.var_747 = param3;
         var _loc4_:ByteArray = new var_1205() as ByteArray;
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_625)
            {
               this.var_1462 = false;
               ITextWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:ByteArray = new var_1204() as ByteArray;
