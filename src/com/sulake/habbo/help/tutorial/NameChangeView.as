package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1242:uint = 13232628;
      
      private static var var_1525:uint = 11129827;
      ...
      private var var_992:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_436);
      ...
      private function showSelectionView() : void
      {
         if(!this.var_642)
         {
            this.var_642 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_642)
            {
               return;
            }
            this._window.content.addChild(this.var_642);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_641)
         {
            this.var_641 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_641)
            {
               return;
            }
            this._window.content.addChild(this.var_641);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_641.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_436;
         }
         this.showView(this.var_641);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_436 = this._controller.myName;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_436);
               break;
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_728:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_725:
               break;
            case ChangeUserNameResultMessageEvent.var_726:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_904 || param1 == ChangeUserNameResultMessageEvent.var_905)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_992 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_992.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1242;
