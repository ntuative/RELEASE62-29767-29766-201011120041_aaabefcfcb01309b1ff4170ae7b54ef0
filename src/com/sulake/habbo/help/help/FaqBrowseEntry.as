      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(this.var_207 != null)
               {
                  _loc3_ = this.var_207.category;
                  main.showUI(HabboHelpViewEnum.const_290);
                  main.tellUI(HabboHelpViewEnum.const_290,_loc3_);
               }
               break;
            case "help_faq_next_entry":
               if(this.getNextItem() != null)
               {
                  main.tellUI(HabboHelpViewEnum.const_228,this.getNextItem());
               }
               break;
            default:
