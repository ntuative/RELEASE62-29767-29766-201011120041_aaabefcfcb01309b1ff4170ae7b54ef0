package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2615:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_563 = param2;
         this.var_54 = param3;
         this.var_1631 = param4;
         this.var_1649 = this.var_563.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || this.var_1649 == null)
            {
               return;
            }
            _loc2_ = this.var_1649.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = this.var_563.assets.getAssetByName(_loc8_) as BitmapDataAsset;
