package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      public function removeRoomInfoListener(param1:RoomToolCtrl) : void
      {
         ...
         for each(_loc3_ in this.var_945)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_948,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         this.onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_1083,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      ...
      {
         var _loc6_:* = null;
         for each(_loc6_ in this.var_943)
         {
      ...
      private function onUserInfo(param1:ModeratorUserInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_944)
         {
      ...
      public function removeChatlogListener(param1:ChatlogCtrl) : void
      {
         var _loc3_:* = null;
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_943)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         for each(_loc3_ in this.var_759)
         {
            _loc3_.onRoomChange();
         }
      }
      ...
      private function onRoomExit(param1:CloseConnectionMessageEvent) : void
      {
         ...
         for each(_loc2_ in this.var_759)
         {
            _loc2_.onRoomChange();
         }
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         this.onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_609,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      
      public function addUserInfoListener(param1:UserInfoCtrl) : void
      {
         this.var_944.push(param1);
      }
