package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1225:int = 6;
      
      public static const const_609:int = 4;
      
      public static const const_1402:int = 9;
      
      public static const const_1296:int = 7;
      
      public static const const_948:int = 3;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1083:int = 5;
      ...
      {
         var _loc2_:Dictionary = this.var_1792[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1792[param1] = _loc2_;
         }
         return _loc2_;
      }
