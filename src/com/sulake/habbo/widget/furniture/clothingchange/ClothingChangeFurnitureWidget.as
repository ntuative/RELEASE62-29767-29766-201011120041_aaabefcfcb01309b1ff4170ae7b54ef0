package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_852:String = "Girl";
      
      private static const const_853:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_911,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_336,this.onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_373:
               ...
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_336:
      ...
      {
         this.hideGenderSelectionInterface();
         this.var_287 = param1.objectId;
         this.var_1959 = param1.objectCategory;
         ...
         this._window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_911,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_336,this.onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         this.var_711 = _loc4_;
         this.var_711.offset(100,100);
         var _loc6_:IWindow = this.var_711.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_365,param1,this.var_287,this.var_1959,this._roomId,this._roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_711 as IFrameWindow;
            if(_loc1_ != null)
            {
