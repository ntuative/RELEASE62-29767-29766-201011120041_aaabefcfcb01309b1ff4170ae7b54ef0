package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1100:Number = 100;
      
      private static const const_1101:Number = 100;
       
      
      private var var_1323:XML;
      ...
      private var var_381:DimmerViewAlphaSlider;
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1323 = XML(_loc1_.content);
         return this.var_1323;
      }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_241.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_241.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_35,0 | 0,new Rectangle(const_1100,const_1101,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_381 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_241 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_241.numTabItems)
         {
            _loc6_ = this.var_241.getTabItemAt(_loc2_);
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_241.selector.getSelected();
         return this.var_241.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_381 != null)
         {
            this.var_381.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1322 = _loc2_.light;
         if(this.var_381 != null)
         {
            this.var_381.setValue(this.var_1322);
         }
         this.var_467 = this.colors.indexOf(_loc2_.color);
         if(this.var_581 != null)
         {
            this.var_581.setSelectedColorIndex(this.var_467);
         }
