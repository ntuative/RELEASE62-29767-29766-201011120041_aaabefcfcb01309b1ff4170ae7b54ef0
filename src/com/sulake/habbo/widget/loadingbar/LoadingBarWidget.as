package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_264,this.onHideLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            this.var_465 = new Sprite();
            this.var_465.addChild(new Bitmap(this.var_39));
            this.var_465.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_465.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_39;
            }
         }
         _loc2_.setDisplayObject(this.var_465);
         this._window.visible = true;
         this._window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1137 != "")
         {
            HabboWebTools.openWebPage(this.var_1137);
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_264,this.onHideLoadingBar);
      }
      
      private function onHideLoadingBar(param1:RoomWidgetLoadingBarUpdateEvent) : void
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_264)
         {
            return;
         }
      ...
      override public function dispose() : void
      {
         if(this.var_465 != null)
         {
            this.var_465.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_465 = null;
         }
         if(this.var_39 != null)
         {
