package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_770[this.var_955] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_347)
         {
            ...
            this.var_347 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_347.center();
            this.var_347.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_955;
         if(this.var_955 < this.var_770.length)
         {
            _loc1_ = this.var_770[this.var_955] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_770.length);
                  _loc2_.text = _loc6_;
               }
