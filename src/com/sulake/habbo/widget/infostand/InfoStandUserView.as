package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_78:IItemListWindow;
      
      private var var_1112:TagListRenderer;
      
      protected var var_57:IItemListWindow;
      
      private var var_186:IBorderWindow;
      
      protected var _widget:InfostandWidget;
      
      private var var_112:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1112 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_186 = this._window.getListItemByName("info_border") as IBorderWindow;
         this.var_57 = this._window.getListItemByName("button_list") as IItemListWindow;
         var _loc4_:* = [];
         this.var_57.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         ...
         {
            this.var_78 = this.var_186.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc6_:IBitmapWrapperWindow = this.var_186.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_186.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_57.numListItems)
            {
               _loc13_ = this.var_57.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_186.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
               _loc10_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.showBadgeInfo);
               _loc10_.addEventListener(WindowMouseEvent.const_26,this.hideBadgeInfo);
            }
            _loc8_++;
         }
         _loc10_ = this.var_186.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_112.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_112.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_112.x = _loc5_.left - this.var_112.width;
         this.var_112.y = _loc5_.top + (_loc5_.height - this.var_112.height) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = this.var_78.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = this.var_78.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = this.var_78.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(this.var_78 == null || this.var_186 == null || this.var_57 == null)
         {
            return;
         }
         this.var_57.width = this.var_57.scrollableRegion.width;
         this.var_78.height = this.var_78.scrollableRegion.height;
         this.var_186.height = this.var_78.height + 20;
         this._window.width = Math.max(this.var_186.width,this.var_57.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_186.width < this.var_57.width)
         {
            this.var_186.x = this._window.width - this.var_186.width;
            this.var_57.x = 0;
         }
         else
         {
            this.var_57.x = this._window.width - this.var_57.width;
            this.var_186.x = 0;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_78.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_78.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = this.var_78.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = this.var_78.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1112.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc6_:* = null;
         var _loc2_:ITextWindow = this.var_78.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_78.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_78.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_57.getListItemByName(param1);
         if(_loc3_ != null)
         {
            _loc3_.visible = param2;
            this.var_57.arrangeListItems();
         }
      }
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_57.getListItemByName(param1) as IRegionWindow;
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_112 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_112 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_57.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_864:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_998:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_112.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = this.var_112.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_112.x = _loc7_.left - this.var_112.width;
         this.var_112.y = _loc7_.top + (_loc7_.height - this.var_112.height) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_78.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_78.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = this.var_78.getListItemByName("image_and_badges_container") as IWindowContainer;
