package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1774:int = 5;
      
      private const const_1775:int = 5;
      
      private var var_1342:Array;
      
      private var var_1072:Rectangle = null;
      ...
      {
         var _loc2_:* = null;
         if(this.var_1342 != null && this.var_1342.indexOf(param1) != -1)
         {
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1073 = 0;
         this.var_1072 = param2.rectangle.clone();
         this.var_1072.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1072.width)
         {
            return false;
         }
         if(this.var_1073 + param1.height > this.var_1072.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1072.width)
         {
            this._offsetX = 0;
            this.var_1073 += param1.height + this.const_1775;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1073);
         this._offsetX += param1.width + this.const_1774;
         return true;
      }
