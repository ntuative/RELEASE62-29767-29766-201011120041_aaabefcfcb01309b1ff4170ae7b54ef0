package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_39:
               this.var_1240.setSelectedGridItem(this);
               this.var_1241 = true;
               break;
            ...
            case WindowMouseEvent.const_26:
               ...
               {
                  this.var_1241 = false;
                  this.var_1240.placePetToRoom(this.var_1162.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1764) : uint(this.const_1765);
      }
