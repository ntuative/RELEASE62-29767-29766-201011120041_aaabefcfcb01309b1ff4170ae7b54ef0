package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_355:uint = 2;
      
      public static const const_437:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_289:uint = 3;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         this.var_721 = false;
         this.var_1108 = false;
         this.var_48.updateItemList(this.var_720);
         this.var_48.updateItemList(this.var_1356);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_48.alertPopup(TradingView.const_865);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_720)
            {
               this.var_721 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1108 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_720)
            {
               this.var_48.alertPopup(TradingView.const_890);
            }
            this.close();
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_721 + " OTHER: " + this.var_1108);
      ...
      {
         this.var_48.setMinimized(param1 != InventoryCategory.const_74);
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_275.length < const_1358)
         {
      ...
      public function close() : void
      {
         if(this.var_663)
         {
            if(this._state != const_169 && this._state != const_222)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_169;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_989);
            this.var_663 = false;
         }
         this.var_48.setMinimized(false);
      }
