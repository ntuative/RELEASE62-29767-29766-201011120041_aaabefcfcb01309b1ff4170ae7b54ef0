package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_692:MarketplaceModel;
      
      private const const_1505:int = 42;
      
      private var var_450:Map;
      
      private var _disposed:Boolean = false;
      
      private const const_1788:int = 0;
      ...
      private const const_1504:int = 120;
      
      private var var_368:String;
      
      private const const_835:int = 1;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_450.add(FurniModel.const_40,new FurniGridView(this.var_62,FurniModel.const_40,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         else if(param1.type == WindowEvent.const_61)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_347);
            }
         }
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_450.getValue(this.var_368);
         if(_loc3_)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_40,FurniModel.const_43];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_368);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_692 && this.var_692.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_368);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_835;
         }
         ...
         {
            _loc2_ = this.const_1507;
         }
         if(this.var_2256 == _loc2_)
         {
            return;
         }
         this.var_2256 = _loc2_;
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1504)
         {
            _loc3_ = this.const_1504;
         }
         else if(_loc3_ < this.const_1505)
         {
            _loc3_ = this.const_1505;
         }
         else
         {
