package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_347:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_516 = new Timer(const_1116,1);
         this.var_516.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_1978 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_40,const_43];
         var _loc6_:int = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_516.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_516.stop();
               this.var_516 = null;
            }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_420.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_420.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_743)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
                  while(_loc8_ < _loc7_)
                  {
                     param1.push(GroupItem(_loc4_[_loc5_]).method_5(_loc8_).id);
                     _loc8_++;
                  }
                  _loc5_++;
               }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_773 == null)
         {
            this.var_773 = this._windowManager.buildFromXML(this.var_1978) as IWindowContainer;
         }
      ...
      public function removeAllLocks() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_40,const_43];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_297:
               ...
               break;
            case InventorySubCategory.const_989:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_40,const_43];
         var _loc8_:int = 0;
      ...
      {
         if(this.var_1195 && param1.type == RoomEngineObjectEvent.const_246)
         {
            this.var_1195 = false;
         }
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_420.add(const_40,new Array());
         this.var_420.add(const_43,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_321 || _loc3_.category == FurniCategory.const_334 || _loc3_.category == FurniCategory.const_320)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_420.getValue(param1);
      }
