package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1101:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1101 = new UserDataManager();
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_224 && this._connection != null)
         {
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1101.connection = param1;
         }
      }
      ...
      {
         var _loc2_:Object = this.var_1344.remove(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_1101 as IUserDataManager;
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1343));
         this.var_1344.add(this.var_1343,getTimer());
         ++this.var_1343;
      }
