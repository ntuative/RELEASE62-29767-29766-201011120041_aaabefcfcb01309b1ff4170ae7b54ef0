   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_264 != null && !this.var_264.disposed)
         {
            ...
            this.var_264.bitmap = new BitmapData(this.var_264.width,this.var_264.height,true,16777215);
            this.var_264.bitmap.fillRect(this.var_264.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_264.width - param1.width) / 2,(this.var_264.height - param1.height) / 2);
            this.var_264.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
      ...
      {
         var _loc8_:* = null;
         this.var_264 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
