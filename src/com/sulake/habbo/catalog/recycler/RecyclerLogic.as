package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_842:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1342:
               this.var_571 = const_381;
               if(this._view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1042:
               if(this._view == null)
               {
                  return;
               }
      ...
      {
         this.var_571 = const_843;
         this.var_106 = new Array(const_160);
         if(param1 == null)
         {
            return;
         }
      ...
      {
         return this.var_1645 != RecyclerStatusMessageEvent.const_1042;
      }
      
      private function get statusActive() : Boolean
      {
         return this.var_571 != const_842;
      }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_106.length < const_160)
         {
            return false;
         }
         var _loc1_:int = 0;
      ...
      {
         return this.active && this.var_571 == const_381;
      }
