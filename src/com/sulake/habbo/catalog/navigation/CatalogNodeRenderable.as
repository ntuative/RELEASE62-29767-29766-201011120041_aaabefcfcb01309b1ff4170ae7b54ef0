package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1198:XML;
      
      private static var var_1197:XML;
       
      
      private var var_2565:IWindowContainer;
      ...
      private var var_1459:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1459 == 4294967295)
            {
               this.var_1459 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1252;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1198) as IWindowContainer;
         }
         else
         {
      ...
      {
         this.var_54 = navigator.catalog.windowManager.buildFromXML(var_1197) as IItemListWindow;
         if(this.var_54 == null)
         {
