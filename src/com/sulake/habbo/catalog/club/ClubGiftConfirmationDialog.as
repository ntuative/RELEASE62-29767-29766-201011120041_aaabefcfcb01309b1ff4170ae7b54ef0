package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_88.localizationId);
               break;
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_88.productContainer)
         {
            return;
         }
         this.var_88.productContainer.view = _loc2_;
         this.var_88.productContainer.initProductIcon(this._controller.roomEngine);
      }
