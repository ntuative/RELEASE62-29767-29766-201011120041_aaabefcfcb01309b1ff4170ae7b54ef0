package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         this._window = this.var_387.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         if(!this.var_387 || !this.var_387.viewer || !this.var_387.viewer.catalog || !this.var_387.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = this.var_387.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:ClubBuyController = (this.var_387.viewer.catalog as HabboCatalog).getClubBuyController();
         (this.var_387.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_88,this.var_387.pageId);
      }
   }
}
