package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1296:MarketPlaceOfferData;
      
      private const const_1509:int = 1;
      
      private const const_1771:int = 40;
      ...
      private const const_1770:int = 10;
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_1508,_loc2_.length);
         if(!this.var_459)
         {
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1509);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_688.length)
         {
            _loc4_ = this.var_688[_loc6_.selection];
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1296.offerId);
            }
            return;
         }
      ...
      public function updateStats() : void
      {
         ...
         {
            case "price_development":
               _loc6_ = new MarketplaceChart(_loc1_.dayOffsets,_loc1_.method_2);
               break;
            case "trade_volume":
         ...
         else if(param1.type == WindowEvent.const_102)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1770;
                  break;
               case "search_input":
                  _loc8_ = this.const_1771;
                  break;
               default:
                  return;
            }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_688 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_688 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_688));
            _loc7_.selection = 0;
         }
      }
