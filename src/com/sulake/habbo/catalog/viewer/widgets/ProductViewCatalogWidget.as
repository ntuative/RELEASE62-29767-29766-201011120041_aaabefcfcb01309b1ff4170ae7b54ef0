package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1294:IScrollbarWindow;
      
      protected var var_1561:XML;
      
      private var var_1637:BitmapData;
      
      private var var_1042:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_831.text = _loc4_;
         this.var_1042.text = _loc5_;
         this.var_831.height = this.var_831.textHeight + 5;
         this.var_1042.y = this.var_831.y + this.var_831.height;
         this.var_1042.height = Math.max(130,this.var_1042.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_398:
                  _loc6_ = this.var_1637.clone();
                  if(this.var_458 != null)
                  {
                     this.var_458.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_458,this.var_1294,this.var_1561);
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_226:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_41,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_256,AvatarAction.const_412);
                              _loc16_.appendAction(AvatarAction.const_260,_loc8_.productClassId);
      ...
      {
         this.var_831 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1042 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_80 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1638 = new Point(this.var_80.x,this.var_80.y);
         this.var_458 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1294 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_458 == null)
         {
         ...
         this.var_1637 = _loc2_.content as BitmapData;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2285)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_80 != null && true)
         {
            ...
            this.var_80.x = this.var_1638.x;
            this.var_80.y = this.var_1638.y;
            if(param3 != null)
            {
