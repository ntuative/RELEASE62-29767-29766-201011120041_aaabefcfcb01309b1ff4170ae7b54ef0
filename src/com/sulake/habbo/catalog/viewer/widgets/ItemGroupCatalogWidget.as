package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = this.var_574[this.var_1063] as Array;
      ...
      {
         var _loc2_:Offer = this.var_574[this.var_1063][this.var_1670];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_400 || _loc1_.pricingModel == Offer.const_505)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_78 || _loc3_.productType == ProductTypeEnum.const_85)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_574.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_574[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1670 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1670] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1063 = var_1134.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1063];
         var _loc3_:Array = this.var_574[this.var_1063] as Array;
