package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      protected var var_1134:IItemGridWindow;
      
      protected var var_1561:XML;
      
      private var var_1253:Map;
      
      private var var_662:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         this.var_1134 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1548.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1253.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_662.offerId == _loc2_)
                  {
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1561) as IWindowContainer;
         this.var_1134.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = this.var_1253.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1548.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1253.getValue(this.var_662.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_662,page.pageId);
      }
      ...
      {
         this.var_1253 = param1.botFigureData;
      ...
      private function populateGridItems() : void
      {
         ...
         this.var_1561 = _loc1_.content as XML;
         var _loc2_:int = 0;
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(this.var_662.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(this.var_662.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_662.localizationId);
