package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_964 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_964 != null)
         {
            this.var_964.addEventListener(WindowKeyboardEvent.const_647,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_964.text));
      }
   }
}
