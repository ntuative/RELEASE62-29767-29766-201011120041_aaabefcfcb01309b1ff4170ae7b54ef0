package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1143:int = -16;
      
      private static const const_828:int = 32;
      
      private static const const_1141:int = 8;
      
      public static const const_451:int = 10;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_802 = new ThumbnailImageConfigurations(this._navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_215,HabboWindowStyle.const_36,0 | (!!param3 ? HabboWindowParam.const_38 : HabboWindowParam.const_36),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_802.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1143,_loc4_.y + const_1142 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2132[param1]);
      }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_802.getImage(ThumbnailEditorModel.const_55,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_828 + _loc3_,param2 * const_1141);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1252 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1252,this.var_1252.rect,new Point(0,0),null,null,true);
      }
   }
}
