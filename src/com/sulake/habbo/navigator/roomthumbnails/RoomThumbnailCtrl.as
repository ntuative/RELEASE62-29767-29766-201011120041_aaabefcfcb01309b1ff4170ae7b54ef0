package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2243:IWindowContainer;
      ...
      {
         this.setEnabled(this.var_1595,this.var_62.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1594,this.var_62.mode != ThumbnailEditorModel.const_55);
         this.setEnabled(this.var_1593,this.var_62.mode != ThumbnailEditorModel.const_33);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_62.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1594 = IButtonWindow(this.find("top_tab"));
         this.var_1593 = IButtonWindow(this.find("obj_tab"));
         this.var_2242 = IWindowContainer(this.find("tile_grid"));
         this.var_2243 = IWindowContainer(this.find("now_editing_container"));
         ...
         Util.setProcDirectly(this.var_1594,this.onTopTabButton);
         Util.setProcDirectly(this.var_1593,this.onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2242;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_451)
            {
      ...
      {
         var _loc1_:IWindowContainer = this.var_2243;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_62.mode == ThumbnailEditorModel.const_37);
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_57,HabboWindowStyle.const_35,HabboWindowParam.const_60,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_215,HabboWindowStyle.const_36,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
