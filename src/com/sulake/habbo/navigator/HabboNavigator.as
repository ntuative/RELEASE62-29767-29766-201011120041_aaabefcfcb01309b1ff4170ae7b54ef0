package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2618:Dictionary;
      ...
      private var var_301:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_649:ISessionDataManager;
      
      private var var_1107:RoomCreateViewCtrl;
      ...
      private var var_341:Tabs;
      
      private var var_274:MainViewCtrl;
      
      private var var_2470:Array;
      
      private var var_844:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1107 = new RoomCreateViewCtrl(this);
         this.var_2468 = new RoomThumbnailRenderer(this);
         this.var_844 = new GuestRoomPasswordInput(this);
         this.var_301 = new GuestRoomDoorbell(this);
         this.var_341 = new Tabs(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_274.startSearch(Tabs.const_223,Tabs.const_313,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_192.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_215,HabboWindowStyle.const_36,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_274.startSearch(Tabs.const_254,Tabs.const_208);
         this.var_341.getTab(Tabs.const_254).tabPageDecorator.tabSelected();
      }
