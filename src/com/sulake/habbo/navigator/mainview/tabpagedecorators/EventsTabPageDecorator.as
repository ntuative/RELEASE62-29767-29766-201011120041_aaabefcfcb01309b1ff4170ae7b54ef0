package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class EventsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_357,Tabs.const_523,_loc1_ < 1 ? "-1" : _loc1_ + "");
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_316 == null)
         {
            this.var_316 = IDropMenuWindow(_loc3_.findChildByName("eventCtgFilter"));
