package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      {
         var _loc1_:int = this.var_457 == null ? 0 : int(this.var_457.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_457 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_457.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
