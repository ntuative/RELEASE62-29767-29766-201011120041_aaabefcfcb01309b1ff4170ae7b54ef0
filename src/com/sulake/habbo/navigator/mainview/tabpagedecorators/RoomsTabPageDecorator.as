package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_316:IDropMenuWindow;
      ...
      public function prepareRoomCategories() : void
      {
         ...
         this.var_316.procedure = null;
         this.var_316.populate(_loc1_);
         this.var_316.selection = 0;
         this.var_316.procedure = this.onChangeFilter;
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_316 == null ? 0 : int(this.var_316.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_243,Tabs.const_364);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_243,Tabs.const_764);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_243,Tabs.const_364,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_316 == null)
         {
            this.var_316 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
