package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2506:IButtonWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.addTag(_loc6_,this.var_845.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2507.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_723.setText(param1.eventDescription);
         this.var_843.setText(this.getTagFromEvent(param1,1));
         this.var_845.setText(this.getTagFromEvent(param1,2));
         this.var_1366.visible = false;
         this.var_1365.visible = true;
         this.var_1364.visible = true;
         this.var_1773.visible = false;
         this.var_1775.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2507 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1773 = ITextWindow(this.find("create_caption"));
            this.var_1775 = ITextWindow(this.find("edit_caption"));
            this.var_1366 = IButtonWindow(this.find("create_button"));
            this.var_1365 = IButtonWindow(this.find("edit_button"));
            this.var_2506 = IButtonWindow(this.find("cancel_button"));
            this.var_1364 = IButtonWindow(this.find("end_button"));
            this.var_897 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1366,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1365,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1364,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2506,this.onCancelButtonClick);
            ...
            this.var_843 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_845 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
      ...
      private function createEvent() : void
      {
         ...
         this.var_845.goBackToInitialState();
         this.var_897.selection = 0;
         this.var_1773.visible = true;
         this.var_1775.visible = false;
      }
   }
}
