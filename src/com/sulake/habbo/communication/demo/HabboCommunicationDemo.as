package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2160:PseudoRandom;
      ...
      private const const_1500:String = "fuselogin";
      
      private var var_276:ICoreCommunicationManager;
      
      private var var_442:IKeyExchange;
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_542 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1554 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2158 = this._habboConfiguration.getKey("external.variables.txt","");
         ...
         if(_loc3_)
         {
            this.var_45.mode = HabboConnectionType.const_495;
            if(this.var_542)
            {
               this.var_45.initConnection(HabboConnectionType.const_227);
            }
            else if(false)
            {
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2159)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1554,this.var_2158));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1500,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_442.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_442.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2160);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2160 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_45.mode)
         {
            case HabboConnectionType.const_495:
               _loc6_ = "";
               ...
               this.var_193.loadBannerImage(_loc7_ + "?token=" + this.var_1257,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1018:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1297:
               this.var_810 = this.generateRandomHexString(30);
               this.var_442 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_442.init(this.var_810);
               _loc8_ = this.var_442.getPublicKey(10);
      ...
      {
         if(this.var_45 && this._habboConfiguration && this.var_19 && this._windowManager)
         {
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_766);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1257);
         ...
         this.var_442 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_442.init(_loc14_);
            _loc15_ = this.var_442.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_810 = _loc14_;
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_45.mode = HabboConnectionType.const_1018;
            }
         }
         this.var_45.initConnection(HabboConnectionType.const_227);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_237);
      }
