   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private function sliderButtonLeftProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_555 != 0)
            {
               _loc3_ = this.var_819 - this.var_555;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1021,param1);
         this.var_819 = param1;
         if(param2)
         {
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_818 || param1.type != WindowEvent.const_312)
         {
            return;
         }
         if(this.var_555 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_555) * this.var_555;
      ...
      {
         return param1 / this.var_1484 * (this.var_1021 - this._minValue) + this._minValue;
      }
