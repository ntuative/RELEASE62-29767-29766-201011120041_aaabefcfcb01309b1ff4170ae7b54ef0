package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_983:IContainerButtonWindow;
      
      private var var_982:IContainerButtonWindow;
      ...
      private function initLocalizations() : void
      {
         ...
         while(this.var_85.localization.getLocalization("wiredfurni.help." + _loc1_ + ".title"))
         {
            ...
            this.var_94.push([_loc2_,_loc3_,_loc4_]);
            _loc1_++;
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc3_:IBitmapWrapperWindow = this.find(this._window,"help_image") as IBitmapWrapperWindow;
         if(!this.var_94 || this.var_94.length == 0)
         {
            return;
         }
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_94[this.var_221][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_94[this.var_221][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_94[this.var_221][1]).value;
      ...
      {
         if(this.var_221 >= this.var_94.length - 1)
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1488 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_982 = this.var_1488.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_982)
         {
            this.var_982.procedure = this.onButtonClick;
         }
         this.var_983 = this.var_1488.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_983)
         {
            this.var_983.procedure = this.onButtonClick;
         }
      ...
      {
         ++this.var_221;
         this.var_221 = Math.min(this.var_221,this.var_94.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_221;
         this.var_221 = Math.max(this.var_221,0);
         this.openPage();
      }
