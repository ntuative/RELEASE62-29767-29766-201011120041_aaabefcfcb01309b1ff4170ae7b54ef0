package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_595,RoomWidgetEcotronBoxOpenMessage.const_603,RoomWidgetEcotronBoxOpenedMessage.const_1400];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_595:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_603:
