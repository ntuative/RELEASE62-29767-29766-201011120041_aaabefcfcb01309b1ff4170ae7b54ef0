package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_971:Number = 0.0;
      
      private var var_627:Point = null;
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(this.var_783.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_41);
                                 ...
                                 if(_loc12_ != 0)
                                 {
                                    this.var_783.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_573,RoomWidgetChatSelectAvatarMessage.const_745];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_573:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_745:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_971 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_971);
            }
            if(this.var_627 == null)
            {
               ...
               this.var_427.y = 0;
               this.var_427.z = 0;
               this.var_627 = _loc4_.getScreenPoint(this.var_427);
               this.var_971 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_427.x = 0;
            this.var_427.y = 0;
            this.var_427.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_427);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_627.x || _loc8_.y != this.var_627.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_627,_loc5_));
