package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_605);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_695);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_591);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_605:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_695:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_591:
