package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1625:Number = 1.0;
      ...
      {
         super();
         this.var_1559 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2170 = parseInt(_loc2_,16);
         this.var_2169 = parseInt(_loc3_,16);
         ...
         this.var_1386 = new ColorTransform(this.var_1625,this.var_1623,this.var_1626,this._alphaMultiplier);
         this.var_1006 = this.generatePaletteMapForGrayscale(this.var_2169,this.var_2170);
      }
      
      public function get reds() : Array
      {
         return this.var_1006.getValue("reds") as Array;
      }
      ...
      {
         return this.var_1006.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1006.getValue("greens") as Array;
      }
      ...
      {
         return this.var_1006.getValue("alphas") as Array;
      }
