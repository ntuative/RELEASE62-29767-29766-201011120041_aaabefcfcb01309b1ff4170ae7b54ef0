   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this._view != null)
         {
            ...
            this.var_460.push(this._view.findChildByName("palette0") as IItemGridWindow);
            this.var_460.push(this._view.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_39)
         {
            ...
            {
               if(this.var_460.length > _loc7_)
               {
                  _loc4_ = this.var_460[_loc7_] as IItemGridWindow;
                  _loc5_ = _loc4_.getGridItemIndex(_loc6_);
                  if(_loc5_ > -1)
                  {
                     this.var_62.selectColor(this.var_1297,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_62.getCategoryData(this.var_1297);
         if(!_loc1_)
         {
            return;
         }
         ...
         while(_loc3_ < this.const_1200)
         {
            ...
            _loc5_ = this.var_460[_loc3_] as IItemGridWindow;
            if(!(!_loc4_ || !_loc5_))
            {
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_39)
         {
            ...
            this.var_62.selectPart(this.var_1297,_loc3_);
         }
      }
