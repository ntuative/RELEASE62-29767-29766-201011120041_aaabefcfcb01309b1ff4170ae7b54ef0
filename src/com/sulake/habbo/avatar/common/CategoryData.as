package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1787:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_769 >= 0 && this._parts.length > this.var_769)
         {
            _loc2_ = this._parts[this.var_769];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_214 || this.var_214.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_214[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_214.length <= param1)
         {
            return null;
         }
         return this.var_214[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_769] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_214)
         {
            for each(_loc2_ in this.var_214 as Array)
            {
               if(_loc2_)
               {
