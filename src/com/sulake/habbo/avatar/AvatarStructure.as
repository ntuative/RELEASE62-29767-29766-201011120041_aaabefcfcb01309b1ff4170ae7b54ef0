package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private static const const_1202:int = 200;
       
      
      private var var_384:PartSetsData;
      
      private var var_1720:PartOffsetData;
      ...
      private var var_272:FigureData;
      
      private var var_428:AnimationData;
      ...
      private var var_866:ActionDefinition;
      
      private var var_1719:AvatarStructureDownloadSet;
      
      private var var_587:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         this.var_161 = param2;
         this.var_875 = param3;
         this.var_272 = new FigureData();
         this.var_384 = new PartSetsData();
         this.var_428 = new AnimationData();
         this.var_1719 = new AvatarStructureDownloadSet();
         this.var_587 = new AnimationManager();
         this.var_588 = param4;
         this.var_1720 = PartOffsetData.getInstance(param3);
      ...
      {
         return this.var_874.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(this.var_588)
         {
            case AvatarType.HUMAN:
               _loc1_ = this.var_161.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!this.var_384.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = this.var_161.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!this.var_428.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = this.var_161.getAssetByName("HabboAvatarFigure").content as XML;
               if(!this.var_272.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = this.var_161.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!this.var_384.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = this.var_161.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!this.var_428.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = this.var_161.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!this.var_272.parse(_loc3_))
               {
                  return;
               }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_587.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_428.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_587.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_272.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_272.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + this.var_588 + " ready to go!");
         if(this.var_588 == AvatarType.HUMAN)
         {
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.HUMAN:
               if(this.var_161.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = this.var_161.getAssetByName("HabboAvatarGeometry").content as XML;
                  this._geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
               ...
               break;
            case AvatarType.PET:
               if(this.var_161.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = this.var_161.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  this._geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.HUMAN:
               if(this.var_161.hasAsset(_loc2_))
               {
                  this.var_161.removeAsset(this.var_161.getAssetByName(_loc2_));
               }
               this.var_1719.add(new AvatarStructureDownload(this.var_161,_loc2_,this.var_272));
               break;
            case AvatarType.PET:
         }
         this.var_1719.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,this.onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_587.getAnimation(param1) as Animation;
      }
      ...
      {
         this.var_874 = new AvatarActionManager(this.var_161,this.var_588);
         this.var_866 = this.var_874.getDefaultAction();
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_708[param1])
         {
            this.var_708[param1] = new Dictionary();
         }
         if(this.var_708[param1][param2])
         {
            return this.var_708[param1][param2];
         }
         this.var_708[param1][param2] = this.var_272.getMandatorySetTypeIds(param1,param2);
         return this.var_708[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_272.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         var _loc1_:int = 1;
         _loc1_ = 0;
         while(_loc1_ < const_1202)
         {
            if(this.var_875.hasAsset("dance" + _loc1_))
            {
               _loc2_ = this.var_875.getAssetByName("dance" + _loc1_).content as XML;
               this.var_587.registerAnimation(this,_loc2_);
            }
            if(this.var_875.hasAsset("fx" + _loc1_))
            {
               _loc2_ = this.var_875.getAssetByName("fx" + _loc1_).content as XML;
               this.var_587.registerAnimation(this,_loc2_);
            }
            _loc1_++;
         }
         this.var_370.events.dispatchEvent(new Event(AvatarRendererUpdateEvent.AVATAR_RENDERER_ANIMATIONS_INITIALIZED_EVENT));
      }
      
      public function getBodyPartData(param1:String, param2:int, param3:String) : AnimationLayerData
      {
         return this.var_587.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getPartActionOffset(param1:int, param2:String, param3:String, param4:String, param5:int, param6:int) : Point
      {
         return this.var_1720.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_272.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_272.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         this.var_1720.loadOffsets(this.var_875);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return this.var_874.sortActions(param1);
      }
   }
}
