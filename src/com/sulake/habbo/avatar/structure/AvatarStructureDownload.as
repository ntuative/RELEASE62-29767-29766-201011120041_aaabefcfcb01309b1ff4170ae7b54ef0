package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_927:String = "AVATAR_STRUCTURE_DONE";
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1598 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2245.appendXML(this.var_1598);
         dispatchEvent(new Event(AvatarStructureDownload.const_927));
      }
   }
}
