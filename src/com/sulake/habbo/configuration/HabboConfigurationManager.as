package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_594 = this.getKey("url_prefix");
         if(this.var_594 != null && this.var_594.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_594 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_594 = this.getKey("url.prefix");
         if(this.var_594.length > 0)
         {
            externalAccessDomain = this.var_594.replace("http://","");
      ...
      {
         var _loc4_:String = this.var_1110[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_594);
      ...
      private function init() : void
      {
         ...
         if(!this.var_815)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_42,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1441);
      }
      ...
      {
         var _loc2_:String = this.var_1110[param1] as String;
         return _loc2_ != null;
      }
