package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1210:IRoomRenderingCanvasMouseListener = null;
      
      private var var_429:Point;
      
      private var var_219:Sprite;
      ...
      private var var_2008:Number = -1.0E7;
      
      private var var_2007:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_219.addChild(this.var_51);
         ...
         this.var_220 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
      ...
      {
         var _loc11_:Number = param1 - this.var_630 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1474,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_526.length)
            {
               this.cleanSprite(this.var_526[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_526 = [];
         }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_888 = true;
            if(this.var_113 != null && this.var_219.getChildIndex(this.var_113) < 0)
            {
               this.var_219.addChild(this.var_113);
               this.var_51.mask = this.var_113;
            }
         }
         else if(!param1 && this.var_888)
         {
            ...
            if(this.var_113 != null && this.var_219.getChildIndex(this.var_113) >= 0)
            {
               this.var_219.removeChild(this.var_113);
         ...
         while(_loc1_ < this.var_294.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1210.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      {
         this.var_429.x -= param1 - this.var_527;
         this.var_527 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_429.y -= param1 - this.var_523;
         this.var_523 = param1;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_527;
         param2 -= this.var_523;
         this.var_429.x = param1;
         this.var_429.y = param2;
         if(this.var_976 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1475;
         }
         this.var_1475 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_976;
         return this.var_1475;
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_525.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_525.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2008 || param2 != this.var_2007)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_525.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_525.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_220.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_220.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_524.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_524.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_527;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_523;
                  if(_loc19_ < this.var_630 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_430.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_527;
                     _loc17_.y = _loc20_ - this.var_523;
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_113 != null)
         {
            this.var_113.graphics.clear();
         }
         else
         {
            this.var_113 = new Sprite();
            this.var_113.name = "mask";
            if(this.var_888)
            {
               this.var_219.addChild(this.var_113);
               this.var_51.mask = this.var_113;
         ...
         this.var_113.graphics.beginFill(0);
         this.var_113.graphics.drawRect(0,0,param1,param2);
         this.var_630 = param1;
         this._ht = param2;
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(param1 == this.var_2005)
         {
            return;
         }
         this.var_220.compress();
         ...
         if(this.var_630 != this.var_2006 || this._ht != this.var_2004)
         {
            _loc9_ = true;
         }
         if(this.var_51.x != this.var_527 || this.var_51.y != this.var_523)
         {
            this.var_51.x = this.var_527;
            this.var_51.y = this.var_523;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_430.sortOn("z",0 | 0);
         if(_loc5_ < this.var_430.length)
         {
            this.var_430.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_430[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2006 = this.var_630;
         this.var_2004 = this._ht;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_220.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_220.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_631 || this.var_631 == 0)
         {
      ...
      public function update() : void
      {
         if(this.var_976 == 0)
         {
            this.checkMouseHits(this.var_429.x,this.var_429.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_976 = 0;
         ++this.var_1474;
      }
      ...
      {
         if(param1 < 0 || param1 >= this.var_430.length)
         {
            return null;
         }
         return this.var_430[param1] as SortableSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_526.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
