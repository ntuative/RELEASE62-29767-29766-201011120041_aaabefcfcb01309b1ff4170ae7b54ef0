package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_213.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_213.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_213 != null)
         {
            ...
            {
               _loc3_ = this.var_213.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_133 != null)
            {
               this.var_133.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_133)
               {
                  this.var_133.removeRoomObject(_loc4_.getInstanceId());
               }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_509.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_509[_loc2_]);
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_133.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_213.getValue(_loc2_) != null)
         {
            return this.var_213.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_213.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_213.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return this.var_213.getValue(String(param1)) as IRoomObjectManager;
      }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_133)
                  {
                     this.var_133.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
