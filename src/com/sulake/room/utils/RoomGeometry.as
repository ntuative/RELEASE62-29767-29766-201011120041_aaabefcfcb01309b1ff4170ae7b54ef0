package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_658:Number = 64;
      
      public static const const_883:Number = 32;
      ...
      private var var_1786:Number = 1.0;
      ...
      private var var_1787:Number = 1.0;
      
      private var var_2590:Number = 500.0;
      
      private var var_1788:Number = 1.0;
      
      private var _x:Vector3d;
      
      private var var_163:Vector3d;
      
      private var var_2589:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1787 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         if(this.var_394 != param1 * this.var_1787)
         {
            this.var_394 = param1 * this.var_1787;
            ++this.var_146;
         }
      }
      ...
      {
         if(this.var_395 != param1 * this.var_1786)
         {
            this.var_395 = param1 * this.var_1786;
            ++this.var_146;
         }
      }
      ...
      {
         if(this.var_393 != param1 * this.var_1788)
         {
            this.var_393 = param1 * this.var_1788;
            ++this.var_146;
         }
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < this.var_2589 || _loc3_ > this.var_2590)
         {
            return null;
         }
      ...
      {
         return new Vector3d(this.var_74.x * this.var_395,this.var_74.y * this.var_393,this.var_74.z * this.var_394);
      }
      ...
      {
         return new Vector3d(this.var_163.x,this.var_163.y,this.var_163.z);
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_658;
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_74.x /= this.var_395;
         this.var_74.y /= this.var_393;
         this.var_74.z /= this.var_394;
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_487 != null)
         {
            ...
            return this.var_487.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_162,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_74.x * this.var_395,this.var_74.y * this.var_393,this.var_74.z * this.var_394);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_163;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_395,param2.y * this.var_393,param2.z * this.var_394);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_395,param3.y * this.var_393,param3.z * this.var_394);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_395,param4.y * this.var_393,param4.z * this.var_394);
