package com.sulake.core.runtime
{
   ...
   class Profiler extends Component implements IProfiler
   {
      ...
      {
         this.var_259 = new Dictionary(true);
         super(param1,param2,param3);
      }
      
      public function stop() : void
      {
         this.var_2575 = getTimer() - this.var_2138;
      ...
      {
         var _loc2_:ProfilerAgent = this.var_259[param1];
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               IDisposable(this.var_259[_loc1_]).dispose();
      ...
      public function getProfilerAgentsInArray() : Array
      {
         ...
         for(_loc3_ in this.var_259)
         {
            _loc2_ = _loc3_ as IUpdateReceiver;
            if(IDisposable(_loc3_).disposed)
            {
               IDisposable(this.var_259[_loc3_]).dispose();
               delete this.var_259[_loc3_];
            }
            else
            {
               _loc1_.push(this.var_259[_loc3_]);
            }
         }
         return _loc1_;
      }
