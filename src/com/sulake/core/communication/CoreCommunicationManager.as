package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1653:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_838[_loc3_];
      ...
      {
         var _loc3_:Array = this.var_838[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_838[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1300)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = this.var_1051[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      override public function dispose() : void
      {
         ...
         this.var_1051 = null;
         this.var_1653 = null;
         for each(_loc2_ in this.var_838)
         {
            while(true)
            {
         ...
         this.var_838 = null;
         for each(_loc3_ in this.var_1300)
         {
         }
         var _loc5_:* = null;
         this.var_1051 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1031:
               _loc3_ = new SocketConnection(param1,this,this.var_1653);
               break;
            default:
