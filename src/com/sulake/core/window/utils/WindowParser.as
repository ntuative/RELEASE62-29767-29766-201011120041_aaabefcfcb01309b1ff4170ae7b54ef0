package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_947:String = "_EXCLUDE";
      
      public static const const_1749:String = "_TEMP";
      ...
      protected var var_1140:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_913:Dictionary;
      
      protected var var_1826:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1140);
         this.var_913 = new Dictionary();
         this.var_1378 = new Dictionary();
         ParamCodeTable.fillTables(this.var_913,this.var_1378);
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1164,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1140)
            {
               delete this.var_1140[_loc1_];
            }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1140[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_947) == -1)
                  {
