package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1022:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_367)
         {
            this.var_367 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_367)
            {
               this.var_367.addEventListener(WindowEvent.const_265,this.scrollBarEventProc);
               this.var_367.addEventListener(WindowEvent.const_235,this.scrollBarEventProc);
            }
         }
         return this.var_367;
      }
      ...
      override public function dispose() : void
      {
         if(this.var_367)
         {
            this.var_367.removeEventListener(WindowEvent.const_265,this.scrollBarEventProc);
            this.var_367.removeEventListener(WindowEvent.const_235,this.scrollBarEventProc);
            this.var_367 = null;
         }
         if(this.var_1022)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1022)
         {
            this.var_1022 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
