package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1114:String = "_CONTENT";
      ...
      protected var var_909:ITabSelectorWindow;
      
      private var var_815:Boolean = false;
      
      protected var var_1818:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1818 = findChildByTag(const_1114) as IWindowContainer;
         }
      ...
      {
         return this.var_909.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_909 = findChildByTag(const_1115) as ITabSelectorWindow;
            if(this.var_909 != null)
            {
               this.var_909.procedure = this.selectorEventProc;
            }
         }
         return this.var_909;
      }
      ...
      {
         return !!this.var_815 ? this.selector.iterator : null;
      }
