package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_374:String = "_DROPMENU_TITLETEXT";
      
      protected static const const_1086:String = "item_array";
      
      protected static const const_1087:String = "_DROPMENU_ITEMLIST";
       
      
      private var var_152:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_152 == null || this.var_152.disposed)
         {
            this.var_152 = context.create(name + "::submenu","",WindowType.const_463,var_75,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_152.setGlobalRectangle(_loc1_);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1086,this._itemArray,PropertyStruct.const_138,this._itemArray.length > 0));
         return _loc1_;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_976:
            case WindowMouseEvent.const_58:
               ...
               break;
            case WindowTouchEvent.const_654:
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1087) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_401,var_75,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_361,var_75,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_504 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_504).setStateFlag(WindowState.const_51,true);
         }
      }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_453,this,null,true);
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_39 || param1.type == WindowTouchEvent.const_399)
         {
            if(param2 is IDropMenuItemWindow)
            {
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1087) as IItemListWindow;
         if(_loc3_ != null)
         {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_152.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      {
         return getChildByName(DropMenuController.const_374) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_755 = false;
            this.getTitleText().text = this.var_504 < this._itemArray.length && this.var_504 > -1 ? this._itemArray[this.var_504] : caption;
         }
      }
   }
}
