package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_815:Boolean = false;
      ...
      {
         this.var_1147 = param1 == null ? "" : param1;
      }
      ...
      private function onRemovedEvent(param1:Event) : void
      {
         ...
         {
            var_17.handleError(WindowContext.const_340,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1141,PropertyStruct.const_49,this.var_1141 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_815 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      {
         if(param1.type == WindowTouchEvent.const_399)
         {
            this.focus();
         }
