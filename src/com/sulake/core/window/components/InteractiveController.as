package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1088:String = "tool_tip_caption";
      
      protected static const const_1482:uint = 500;
      
      protected static const const_797:String = "";
      
      protected static var var_251:Array;
      ...
      protected var var_1381:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         this.var_401 = new Array();
         this.var_401[0] = MouseCursorType.const_337;
         this.var_401[1] = MouseCursorType.const_35;
         this.var_401[2] = MouseCursorType.const_337;
         this.var_401[3] = MouseCursorType.const_337;
         this.var_401[4] = MouseCursorType.const_35;
         this.var_401[5] = MouseCursorType.const_35;
         this.var_401[6] = MouseCursorType.const_337;
         if(var_251 == null)
         {
            var_251 = new Array();
            var_251[0] = WindowState.const_96;
            var_251[1] = WindowState.const_80;
            var_251[2] = WindowState.WINDOW_STATE_HOVERING;
            var_251[3] = WindowState.const_66;
            var_251[4] = WindowState.const_51;
            var_251[5] = WindowState.const_81;
            var_251[6] = WindowState.const_70;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1088,param1.toolTipCaption,PropertyStruct.const_91,param1.toolTipCaption != const_797));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_253,param1.toolTipDelay != const_1482));
         return param2;
      }
      ...
      {
         if(param1.toolTipCaption != const_797)
         {
      ...
      {
         this.var_1147 = param1 == null ? const_797 : param1;
      }
