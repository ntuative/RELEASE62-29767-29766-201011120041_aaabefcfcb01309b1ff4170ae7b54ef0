package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_374:String = "_BTN_TEXT";
         ...
         if(event is WindowNotifyEvent)
         {
            switch(event.type)
            {
               ...
               case WindowNotifyEvent.const_772:
                  try
                  {
                     getChildByName(const_374).blend = getChildByName(const_374).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_976:
                  type = "null";
                  break;
               case WindowTouchEvent.const_399:
                  type = "null";
            }
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(getChildByName(const_374));
         if(_loc2_ != null)
         {
            _loc2_.text = caption;
         }
