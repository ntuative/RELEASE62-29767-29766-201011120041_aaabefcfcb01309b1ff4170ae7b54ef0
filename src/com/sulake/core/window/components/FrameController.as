package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_857:String = "margin_top";
      
      private static const const_1205:String = "_SCALER";
      
      private static const const_858:String = "margin_right";
      
      private static const const_1204:String = "_HEADER";
      
      private static const const_1104:String = "_TITLE";
      
      private static const const_1203:String = "_CONTENT";
      
      private static const const_855:String = "margin_left";
      
      private static const const_856:String = "margin_bottom";
      ...
      private var var_1341:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_855,_loc3_.left,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_857,_loc3_.top,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_858,0 - _loc3_.right,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_856,0 - _loc3_.bottom,PropertyStruct.const_54,_loc2_));
         return _loc1_;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1090,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_288);
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1341 = findChildByTag(const_1204) as IHeaderWindow;
            if(!this.var_1341)
            {
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1104) as ITextWindow;
            if(!this._title)
            {
      ...
      {
         return findChildByTag(const_1205) as IScalerWindow;
      }
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_149 = findChildByTag(const_1203) as IWindowContainer;
            if(!this.var_149)
            {
