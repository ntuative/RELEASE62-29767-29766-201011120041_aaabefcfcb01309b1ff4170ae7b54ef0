package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1483:String = "_IGNORE_INHERITED_STYLE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      private static var var_1037:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      private static var var_1287:Point = new Point();
      
      protected static const const_1090:String = "_COLORIZE";
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_337 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_55 = var_337.clone();
            var_11 = var_337.clone();
         ...
         if(_loc13_)
         {
            var_667 = _loc13_.blend;
            var_398 = _loc13_.treshold;
            if(var_490 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_399 != _loc13_.color)
            {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_111,WindowParam.const_142);
         var _loc2_:* = !testParamFlag(WindowParam.const_132,WindowParam.const_144);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_311.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_311.height;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_339)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_371)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_490 = param1;
         var_399 = !!var_490 ? uint(var_399 | var_1135) : uint(var_399 & 16777215);
      ...
      {
         var_398 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2262 + "]";
      }
      ...
      {
         var _loc3_:uint = var_75;
         var _loc4_:*;
         var_75 = !!param2 ? (_loc4_ = var_75 | param1, var_75 |= param1, uint(_loc4_)) : (_loc4_ = var_75 & ~param1, var_75 &= ~param1, uint(_loc4_));
         if(var_75 != _loc3_)
         {
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1076,this,null);
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1061;
         this.update(this,_loc1_);
         return true;
      }
      ...
      {
         var_667 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_945);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1286 || _loc3_.hasGraphicsContext())
         {
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param4 != null && var_125 != null)
         {
            param4.x = var_125.x;
            param4.y = var_125.y;
            param4.width = var_125.width;
            param4.height = var_125.height;
         }
      }
      ...
      {
         return !testParamFlag(WindowParam.const_31) || this.var_20 != null;
      }
      
      public function validateLocalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_398);
      }
      
      public function set color(param1:uint) : void
      {
         var_1135 = param1 & 4278190080;
         var_399 = !!var_490 ? uint(param1) : uint(param1 & 16777215);
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_76);
      }
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1277:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1440:
               _loc2_ = "null";
               break;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_167:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_388,this,null));
                     ...
                     if(this.var_13 != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_472))
                        {
                  ...
                  break;
               case WindowNotifyEvent.const_522:
                  var_17.invalidate(this,var_11.union(var_55),WindowRedrawFlag.const_390);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1021,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_278,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_332:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_751,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_239,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_458:
                  var_17.invalidate(this,var_11,WindowRedrawFlag.const_996);
                  break;
               case WindowNotifyEvent.const_456:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1483) == -1)
                     {
                        _loc8_.style = var_75;
                     }
                  }
               ...
               case WindowNotifyEvent.const_443:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        this.setupGraphicsContext();
                        var_17.invalidate(this,var_11,WindowRedrawFlag.const_390);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_239:
                  ...
                  break;
               case WindowNotifyEvent.const_388:
                  this.var_13.getRegionProperties(null,this.var_311);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_335:
      ...
      {
         return this.var_740 != null ? this.var_740 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1051,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_398);
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1286 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_623,this,param1));
         return param1;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_906,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_722,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_522,this,null));
            }
            if(_loc6_)
            {
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_311 = this.var_13.rectangle.clone();
               var_55.x = var_11.x;
               var_55.y = var_11.y;
               var_55.width = var_11.width;
               var_55.height = var_11.height;
            ...
            else
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_914,this,_loc2_));
            }
         }
      }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = this.getParamFlag(WindowParam.const_68);
         for each(_loc1_ in this._children)
         {
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_68,false);
            }
            ...
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_68,true);
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_75,_param,var_17,var_11,null,this.var_740,this.properties,var_734.concat(),_id) as WindowController;
         ...
         _loc2_.var_1135 = var_1135;
         _loc2_.var_735 = var_735;
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_246;
         _loc2_.background = var_490;
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_125.x = param3.x;
            var_125.y = param3.y;
            var_125.width = param3.width;
            var_125.height = param3.height;
         }
         if(param2 != null)
         {
