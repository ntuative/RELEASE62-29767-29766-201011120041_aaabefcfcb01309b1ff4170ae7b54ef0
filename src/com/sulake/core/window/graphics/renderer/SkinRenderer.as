package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_498:Dictionary;
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_339[param1.name];
         if(param1 != null)
         {
            ...
            delete this.var_339[param1.name];
         }
         return param1;
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_498)
            {
               ISkinLayout(this.var_498[_loc1_]).dispose();
               delete this.var_498[_loc1_];
            }
            this.var_498 = null;
            this.var_405 = null;
            for(_loc1_ in this.var_339)
            {
               ISkinTemplate(this.var_339[_loc1_]).dispose();
      ...
      {
         this.var_339[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in this.var_405)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_405[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_498[param1.name];
         }
         return param1;
      }
      ...
      {
         return this.var_405[param1] != null;
      }
