package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected static var var_284:uint = 0;
      
      public static const GC_TYPE_TEXTFIELD:uint = 2;
      
      public static const const_1732:uint = 128;
      ...
      protected var var_736:Boolean;
      
      protected var var_1824:Boolean;
      
      protected var var_168:Shape;
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_736)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_284 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(this.var_736)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_284 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1824,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1824,16777215);
                  }
                  var_284 += bitmap.width * bitmap.height * 4;
               }
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_168)
            {
               this.var_168 = new Shape();
               this.var_168.visible = false;
               this.var_168.cacheAsBitmap = true;
               super.addChild(this.var_168);
            }
            this.var_168.graphics.clear();
            this.var_168.graphics.beginFill(255);
            this.var_168.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_168.graphics.endFill();
            this.getDisplayObject().mask = this.var_168;
         }
         else if(this.var_168)
         {
            super.removeChild(this.var_168);
            this.var_168.graphics.clear();
            this.var_168 = null;
