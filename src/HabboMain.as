package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_798:Number = 0.71;
      ...
      private var var_1149:HabboTracking;
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_798 + this.var_23.getNumberOfFilesLoaded() / _loc11_ * const_798;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1149 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1149 && !this.var_1149.disposed)
                  {
                     this.var_1149.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
